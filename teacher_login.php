...
<body>
	...
	<center>
		...
		<form method="POST">
			<div>
			<br><br>
			<img src="teacher.png"; height=100px; width=100px;>
			<p> Teacher login</p>
			</div>
			<div>
				<br>
...
$pass=$_POST['Password'];
$select="select email,password from teacherdata where email= '$email' AND password ='$pass';";
$ros=mysqli_query($con,$select);
$rows=mysqli_num_rows($ros);
if($rows>0)
{
	echo "<script>alert('login succesful');</script>";
	header("Location:http://localhost/project/homepage_teacher.php");
}
else
{
