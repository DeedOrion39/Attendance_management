...
<html lang-"en-US">
    ...
    <body>
        ...
        <ul class="nav">
            ...
            <li><a href="file:///D:/Academics/SE%20Project/HTML/manage_student_admin.html">MANAGE STUDENT</a></li>
        ...
        <form method="POST">
            <div class="rows">
                ...
                <input style="margin-left:38px;margin-right:100px; height:22px;" name="Student_Id" placeholder="" required="Please fill this">
            ...
            <div class="rows">
                ...
                <input type="number" style="margin-left:10px;margin-right:100px; height:22px;" name="Roll_Number" placeholder="" required="Please fill this">
            ...
            <div class="rows">
                ...
                <input type="number" style="margin-left:10px;margin-right:100px; height:22px;" name="Mobile_Number" placeholder="" required="Please fill this">
            </div>
