...
<html lang-"en-US">
    ...
    $stu="select max(teacher_id) as number from teacherdata;";
    ...
    <body>
        ...
        <form method = "POST">
			<div class="rows">
				...
				<input readonly style="margin-left:65px; height:22px;" name="Teacher_Id"  placeholder="" required="Please fill this" value="<?php echo $row['number']+1;?>">
			</div>
			<div class="rows">
