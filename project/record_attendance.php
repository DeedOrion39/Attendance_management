...
<html lang-"en-US">
    ...
    <body>
        ...
        <div class="Firstline">
            <p class="Firstline_date">Date: <span id="datereal"></span></p>
        ...
        include 'connection.php';
         if(isset($_GET['Class'])&&isset($_GET['subjects']))
                {
                  $class=$_GET['Class']; $subject=$_GET['subjects'];
        ...
        <table  border="1px">
         ...
         <?php 
                ...
                foreach($query as $values)
            {
                ...
                <td><input required=\"\" type=\"button\" class=\"mybutton\" name=\"stat_$i\" onclick=\"myFunction($i)\" value=\"Present\"></td>
                <td><input name=\"nota_$i\" style=\"margin-left:40px;margin-right:100px; height:22px; width:250px;\" type=\"text\"  placeholder=\"enter note if any within 30 words\"></td>
                    </tr>";
    ...
    <?php      
            ...
            $index=$_POST["nota_$i"];
            $cquery=$cquery."INSERT INTO attendence VALUES ('{$values['student_id']}','{$status}','{$index}',curdate(),'$subject');";
            ...
            if($ros)
            {
              echo"<script>alert('Data was successfully inserted');</script>";
               header("Location:http://localhost//project/record_attendance.php");
               ob_enf_fluch();
            }
            else
            {
