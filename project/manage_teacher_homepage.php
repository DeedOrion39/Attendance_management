        ...
        <table>
            <tr class="card">
                <td class="box">
                    NEW DATA
                    <br>
                    <button style="margin-top: 90px;" onclick="document.location='teacher.php'">ADD</button>
                </td>
                <td class="box">
                    MANAGE DATA
                    <br>
                    <button style="margin-top: 90px;" onclick="document.location='teacher2.php'">MANAGE</button>
                </td>
                <td class="box">
                    TEACHER LIST
                    <br>
                    <button style="margin-top: 90px;" onclick="document.location='manage_teacher_teacherlist.php'">VIEW</button>
                </td>
            </tr>
        </table>
        </center>
