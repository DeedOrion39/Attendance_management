...
<html lang-"en-US">
    ...
    <body>
        ...
        <ul class="nav">
         ...
         <form method="GET" action="teacher3.php">
            <br><br><br><br><br><br><br>
            <center>
            <label for="teacher_id">Teacher ID:</label>
            <input type="number" id="teacher_id" style="margin-left:38px;margin-right:100px; height:22px;" placeholder="enter Teacher id" required="Please fill this" name="search"><input type="submit" name="subid" value="submit">
